...
public class CategoryControllerIntegrationTest {
	...
	public void getAll_ReturnsOkAndCategories() {
		...
		ResponseEntity<CategoryDTO[]> responseEntity = restTemplate.exchange("/categories", HttpMethod.GET, httpEntity,
				CategoryDTO[].class);
	...
	public void getOne_ExistentId_ReturnsOkAndCategory() {
		...
		ResponseEntity<CategoryDTO> responseEntity = restTemplate.exchange("/categories/" + EXISTENT_ID, HttpMethod.GET,
				httpEntity, CategoryDTO.class);
	...
	public void getOne_NonexistentId_ReturnsNotFound() {
		HttpEntity<Object> httpEntity = new HttpEntity<>(getAuthHeadersAdmin(restTemplate));
		ResponseEntity<CategoryDTO> responseEntity = restTemplate.exchange("/categories/" + NONEXISTENT_ID,
				HttpMethod.GET, httpEntity, CategoryDTO.class);
	...
	public void add_ValidCategory_ReturnsOkAndCategory() {
		...
		ResponseEntity<CategoryDTO> responseEntity = restTemplate.exchange("/categories", HttpMethod.POST, httpEntity,
				CategoryDTO.class);
	...
	public void update_ValidNewCategory_ReturnsOk() {
		...
		ResponseEntity<CategoryDTO> responseEntity = restTemplate.exchange("/categories/" + EXISTENT_ID, HttpMethod.PUT,
				httpEntity, CategoryDTO.class);
...
//                .exchange("/categories/" + EXISTENT_ID, HttpMethod.PUT, httpEntity, CategoryDTO.class);
	...
	public void delete_ExistentIdNoSubcategories_ReturnsOk() {
		...
		HttpEntity<Object> httpEntity = new HttpEntity<>(getAuthHeadersAdmin(restTemplate));
		ResponseEntity<Void> responseEntity = restTemplate.exchange("/categories/" + EXISTENT_ID_2, HttpMethod.DELETE,
...
//        restTemplate.exchange("/categories", HttpMethod.POST, httpEntity, CategoryDTO.class);
	...
	public void delete_ExistentIdHasSubcategories_ReturnsBadRequest() {
		HttpEntity<Object> httpEntity = new HttpEntity<>(getAuthHeadersAdmin(restTemplate));
		ResponseEntity<Void> responseEntity = restTemplate.exchange("/categories/" + EXISTENT_ID, HttpMethod.DELETE,
				httpEntity, Void.class);
		assertEquals(HttpStatus.BAD_REQUEST, responseEntity.getStatusCode());
	}
	...
	public void delete_NonexistentId_ReturnsNotFound() {
		HttpEntity<Object> httpEntity = new HttpEntity<>(getAuthHeadersAdmin(restTemplate));
		ResponseEntity<Void> responseEntity = restTemplate.exchange("/categories/" + NONEXISTENT_ID, HttpMethod.DELETE,
				httpEntity, Void.class);
		assertEquals(HttpStatus.NOT_FOUND, responseEntity.getStatusCode());
	}
